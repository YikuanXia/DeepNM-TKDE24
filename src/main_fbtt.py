...
parser.add_argument('--al_len', type=int, default=1043)
parser.add_argument('--e1_path', type=str, default="../data/fb-tt1-edges")
parser.add_argument('--e2_path', type=str, default="../data/fb-tt2-edges")
parser.add_argument('--f1_path', type=str, default=None)
parser.add_argument('--f2_path', type=str, default=None)
parser.add_argument('--model_path', type=str, default="best_model_fbtt")
parser.add_argument('--n1', type=int, default=1043)
parser.add_argument('--n2', type=int, default=1043)
parser.add_argument('--max_degree', type=int, default=32)
parser.add_argument('--train_size', type=int, default=int(1043*0.1))
...
parser.add_argument('--lambdaa', type=float, default=1.0)
